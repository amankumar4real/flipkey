...
export const postReg=payload=>dispatch=>{
    ...
    console.log(payload)
    dispatch(regStart)
    return axios.post('https://cf059a80cd74.ngrok.io/user/register', payload)
    .then(res=>res.data)
...
export const postLogin=payload=> dispatch =>{
    ...
    return axios.post("https://cf059a80cd74.ngrok.io/user/login", payload)
    .then(res=>res.data)
...
export const afterAuth =payload=> dispatch =>{
    ...
    return axios.post("https://cf059a80cd74.ngrok.io/user/google_auth", payload)
    .then(res=>res.data)
