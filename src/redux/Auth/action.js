...
export const postReg=payload=>dispatch=>{
    ...
    console.log(payload)
    dispatch(regStart)
    return axios.post('https://0e0c54c7cca6.ngrok.io/user/register', payload)
    .then(res=>res.data)
...
export const postLogin=payload=> dispatch =>{
    ...
    return axios.post("https://0e0c54c7cca6.ngrok.io/user/login", payload)
    .then(res=>res.data)
...
export const afterAuth =payload=> dispatch =>{
    ...
    return axios.post("https://0e0c54c7cca6.ngrok.io/user/google_auth", payload)
    .then(res=>res.data)
