...
export const postReg=payload=>dispatch=>{
    ...
    console.log(payload)
    dispatch(regStart)
    return axios.post('https://29be48647e3d.ngrok.io/user/register', payload)
    .then(res=>res.data)
...
export const postLogin=payload=> dispatch =>{
    ...
    return axios.post("https://29be48647e3d.ngrok.io/user/login", payload)
    .then(res=>res.data)
...
export const afterAuth =payload=> dispatch =>{
    ...
    return axios.post("https://29be48647e3d.ngrok.io/user/google_auth", payload)
    .then(res=>res.data)
